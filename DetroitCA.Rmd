...
# Clean-up
remove(var, vars, rec.area.dist, roads.dist)
```

Finally, we want to mask out the pixels outside of the census tracts.

```{r}
layers$cover <- mask(dev2001, layers$pop.density, maskvalue=NA)

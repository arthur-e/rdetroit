...
dev2011 <- raster::reclassify(rast2006, reclass.matrix, right=TRUE)
```
...
cols <- c(cols[1], '#FFFFFF00', cols[4], cols[5])

#cols <- c('#77DD00', '#FFFFFF00', '#113355')
#par(mfrow=c(2,1))
plot(counties, col='#AAAAAA', legend=FALSE)
plot(diff0601, breaks=c(-2, -1, 0, 1, 2), add=TRUE,
     col=cols)
legend('bottomright', fill=rev(cols), title='New Development',

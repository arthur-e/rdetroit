...
ogr2ogr -sql "SELECT t10.GEOID10 AS GEOID, w.* FROM t10 LEFT JOIN '/usr/local/dev/rdetroit/csv/w.csv'.w ON t10.GEOID10 = w.FIPS" /usr/local/dev/rdetroit/shp/tracts2000.shp /usr/local/dev/rdetroit/shp/t10.shp
ogr2ogr -sql "SELECT t10.GEOID10 AS GEOID, t.* FROM t10 LEFT JOIN '/usr/local/dev/rdetroit/csv/t.csv'.t ON t10.GEOID10 = t.FIPS" /usr/local/dev/rdetroit/shp/tracts2006.shp /usr/local/dev/rdetroit/shp/t10.shp
```

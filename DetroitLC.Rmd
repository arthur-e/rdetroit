...
require(raster)
rast <- raster::raster(paste0(file.loc, 'nlcd2006.tif'))
```
...
```
ogr2ogr -f "ESRI Shapefile" -where "NFC IN (1,2,3)" -clipsrc WayneOakMac_counties.shp semich_roads.shp allroads_miv14a.shp
gdal_rasterize -tr 30 30 -init 0 -burn 1 semich_roads.shp roads.tiff
```

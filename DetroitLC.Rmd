...
* Normalized by total population (`SE_T025_001`, `SE_T001_001`)...
  ...
  * Black or African American population (`SE_T014_002`, `SE_T013_003`)
...
census.vars <- c('SE_T003_001', 'SE_T093_001', 'SE_T155_001', 'SE_T156_001', 'SE_T156_002', 'SE_T004_002', 'SE_T005_002', 'SE_T005_003', 'SE_T014_002', 'SE_T014_005', 'SE_T020_001', 'SE_T020_002', 'SE_T020_003', 'SE_T020_005', 'SE_T020_006', 'SE_T020_008', 'SE_T020_009', 'SE_T025_001', 'SE_T185_004')
...
require(plyr)
census2000 <- subset(mutate(census2000, trtid=paste0(Geo_STATE, Geo_COUNTY, Geo_TRACT)),
                     select=census.vars)
acs2006.2010 <- subset(mutate(acs2006.2010, trtid=paste0(Geo_STATE, Geo_COUNTY, Geo_TRACT)),
                       select=census.vars)
